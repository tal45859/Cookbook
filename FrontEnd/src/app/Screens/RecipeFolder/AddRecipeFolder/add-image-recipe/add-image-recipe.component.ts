...
@Component({
  selector: 'app-add-image-recipe',
  templateUrl: './add-image-recipe.component.html',
  styleUrls: ['./add-image-recipe.component.css']
})
export class AddImageRecipeComponent implements OnInit {
...
async GetAllImage()
{
 (await this.HttpImage.GetAllImageByRecipeId(this.RecipIdLast)).subscribe((response)=>{this.AllNewImageArr=response});
}
